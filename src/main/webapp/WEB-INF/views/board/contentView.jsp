...
"location.href='${contextPath }/board/delete?writeNo=${personalData.writeNo }&imageFileName=${personalData.imageFileName}'">

				</c:if> 
				<input type="button" onclick="" value="답글달기"> 
				<input type="button" onclick="location.href='${contextPath }/board/boardAllList" value="리스트로 돌아가기"></td>
		</tr>
	</table>
